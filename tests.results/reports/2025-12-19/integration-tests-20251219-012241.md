...
**Execution Time**: 2025-12-19 01:22:41
**Timestamp**: 20251219-012241
...
Multi-Directory Integration
  ...
  backward compatibility - single directory (T041)
    [1m[31mprocesses single directory without prefix (identical to pre-feature behavior) (FAILED - 3)[0m
...
[37m  3) Multi-Directory Integration backward compatibility - single directory (T041) processes single directory without prefix (identical to pre-feature behavior)[0m
[1m[36m     When call printf %s single_dir[0m

     3.1) [31mWhen call pndcgn_generate_prefixed_filename  file.md pdf[0m
          ...
          [36m# tests/integration/multi_dir_spec.sh:173[0m

     3.2) [31mThe output should eq file.pdf[0m

            [31mexpected: "file.pdf"[0m
            [31m     got: "single_dir"[0m

          [36m# tests/integration/multi_dir_spec.sh:174[0m

Finished in 6.15 seconds (user 1.54 seconds, sys 1.95 seconds)
[31m27 examples, 1 failure, 2 warnings[0m
...
[1m[31mshellspec tests/integration/multi_dir_spec.sh:155[0m [36m# 3) Multi-Directory Integration backward compatibility - single directory (T041) processes single directory without prefix (identical to pre-feature behavior) FAILED[0m
