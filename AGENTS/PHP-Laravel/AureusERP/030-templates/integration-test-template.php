...
/**
 * Integration Test Template for AureusERP Plugin Service Tests
 *
 * This template demonstrates how to structure integration tests for services in AureusERP plugins.
 * All examples use the Webkul\ namespace convention used by the aureauserp/aureuserp package.
...
// Import the service being tested (using Webkul\ namespace)
use Webkul\YourPlugin\Services\YourService;
// Import any related models or dependencies (using Webkul\ namespace)
