...
This document provides comprehensive workflow guidelines for development teams, covering Git workflows, terminal management, and development processes. These guidelines ensure consistency, quality, and efficiency across all project activities.

## 2. Core Workflow Principle

**All workflows should be systematic, documented, and suitable for junior developers to understand, follow, and execute effectively.**
...
- **Code Formatting**: Runs Laravel Pint
- **Static Analysis**: Runs PHPStan at Level 10
...
- **Documentation Checks**: Verify documentation completeness

### 6.3. Code Review Standards

- **Standards Compliance**: Verify adherence to development standards
- **Test Coverage**: Ensure adequate test coverage
- **Security Review**: Check for security vulnerabilities
- **Performance Impact**: Consider performance implications
- **Documentation**: Verify proper documentation
...
- **[Security Standards](../PHP-Laravel/040-security-standards.md)** - Security review and audit requirements
- **[Performance Standards](../PHP-Laravel/050-performance-standards.md)** - Performance monitoring and optimization
...
4. **Security**: Check [Security Standards](../PHP-Laravel/040-security-standards.md) requirements
5. **Performance**: Consider [Performance Standards](../PHP-Laravel/050-performance-standards.md) impact

## 9. Navigation

[←  AI-Assisted Development Workflows](010-workflows.md) | [↑ Top](#workflow-guidelines) |  [Product Requirements Document Workflow →](030-prd-workflow.md)