...
**Execution Time**: 2025-12-19 01:00:16
**Timestamp**: 20251219-010016
...
Multi-Directory Integration
  ...
  abbreviated prefixes (T023)
    [1m[31mgenerates abbreviated prefixes for frontend/backend directories (FAILED - 3)[0m
    [1m[31muses prefixes in output filenames when multiple directories (FAILED - 4)[0m
    [1m[32mdoes not use prefix for single directory (backward compatibility)[0m
  single run ID (T024)
    [1m[31mcreates single run ID for multiple source directories (FAILED - 5)[0m
  backward compatibility - single directory (T041)
    [1m[31mprocesses single directory without prefix (identical to pre-feature behavior) (FAILED - 6)[0m
  graceful degradation (FR-010)
    [1m[31mcontinues processing when one directory fails (FAILED - 7)[0m
...
[37m  3) Multi-Directory Integration abbreviated prefixes (T023) generates abbreviated prefixes for frontend/backend directories[0m
[1m[36m     When call pndcgn_compute_abbreviated_prefixes /var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/frontend /var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/backend[0m

     3.1) [31mThe output should include front[0m

            [31mexpected "fro[0m
            [31mbac" to include "front"[0m

          [36m# tests/integration/multi_dir_spec.sh:87[0m

     3.2) [31mThe output should include back[0m

            [31mexpected "fro[0m
            [31mbac" to include "back"[0m

          [36m# tests/integration/multi_dir_spec.sh:88[0m

[37m  4) Multi-Directory Integration abbreviated prefixes (T023) uses prefixes in output filenames when multiple directories[0m
[1m[36m     When call pndcgn_generate_prefixed_filename front file.md pdf[0m

     4.1) [31mWhen call pndcgn_generate_prefixed_filename back file.md pdf[0m
     ...
     4.2) [31mThe output should eq back--file.pdf[0m
...
[37m  5) Multi-Directory Integration single run ID (T024) creates single run ID for multiple source directories[0m
[1m[36m     When call printf %s 01KCT1YFSFJB019MWYP7000000[0m

     5.1) [31mWhen call printf %s [
  "/var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/dir1",
  "/var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/dir2"
][0m
     ...
     5.2) [31mThe output should include /var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/dir1[0m

            [31mexpected "01KCT1YFSFJB019MWYP7000000" to include "/var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/dir1"[0m

          [36m# tests/integration/multi_dir_spec.sh:145[0m

     5.3) [31mThe output should include /var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/dir2[0m

            [31mexpected "01KCT1YFSFJB019MWYP7000000" to include "/var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/dir2"[0m

          [36m# tests/integration/multi_dir_spec.sh:146[0m

[37m  6) Multi-Directory Integration backward compatibility - single directory (T041) processes single directory without prefix (identical to pre-feature behavior)[0m
[1m[36m     When call printf %s 01KCT1YG92J6GGES5ZF5000000[0m

     6.1) [31mWhen call pndcgn_generate_prefixed_filename  file.md pdf[0m
     ...
     6.2) [31mThe output should eq file.pdf[0m

            [31mexpected: "file.pdf"[0m
            [31m     got: "01KCT1YG92J6GGES5ZF5000000"[0m

          [36m# tests/integration/multi_dir_spec.sh:179[0m

[37m  7) Multi-Directory Integration graceful degradation (FR-010) continues processing when one directory fails[0m
[1m[36m     When call printf %s /var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/valid_dir/file.md[0m

     7.1) [31mWhen call printf %s [0m
     ...
     7.2) [31mThe output should eq [0m

            [31mexpected: ""[0m
            [31m     got: "/var/folders/f0/2m6r6db57bxglzky2b_f49n00000gn/T/tmp.Tk63f77De8/valid_dir/file.md"[0m

          [36m# tests/integration/multi_dir_spec.sh:207[0m

Finished in 5.68 seconds (user 1.51 seconds, sys 1.91 seconds)
[31m26 examples, 7 failures[0m
...
[1m[31mshellspec tests/integration/multi_dir_spec.sh:81[0m [36m# 3) Multi-Directory Integration abbreviated prefixes (T023) generates abbreviated prefixes for frontend/backend directories FAILED[0m
[1m[31mshellspec tests/integration/multi_dir_spec.sh:94[0m [36m# 4) Multi-Directory Integration abbreviated prefixes (T023) uses prefixes in output filenames when multiple directories FAILED[0m
[1m[31mshellspec tests/integration/multi_dir_spec.sh:118[0m [36m# 5) Multi-Directory Integration single run ID (T024) creates single run ID for multiple source directories FAILED[0m
[1m[31mshellspec tests/integration/multi_dir_spec.sh:153[0m [36m# 6) Multi-Directory Integration backward compatibility - single directory (T041) processes single directory without prefix (identical to pre-feature behavior) FAILED[0m
[1m[31mshellspec tests/integration/multi_dir_spec.sh:187[0m [36m# 7) Multi-Directory Integration graceful degradation (FR-010) continues processing when one directory fails FAILED[0m
