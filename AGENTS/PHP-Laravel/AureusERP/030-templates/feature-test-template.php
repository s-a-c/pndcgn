...
/**
 * Feature Test Template for AureusERP Plugin Resource Tests
 *
 * This template demonstrates how to structure feature tests for resources in AureusERP plugins.
...
// Import the model being tested (using Webkul\ namespace)
